...
urlpatterns = [
    ...
    path('<uuid:tenant_id>/<uuid:pk>/teams/<uuid:team_id>/sprint/', views.ProjectSprint.as_view(), name='project-team-sprint'),
    path('<uuid:tenant_id>/<uuid:pk>/sprints/<uuid:sprint_id>/', views.ProjectSprint.as_view(), name='project-sprint'),
    path('<uuid:tenant_id>/<uuid:pk>/sprints/<uuid:sprint_id>/stories/<uuid:story_id>/', views.ProjectSprint.as_view(), name='project-sprint-story'),
