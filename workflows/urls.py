...
urlpatterns = [
    ...
    path('<uuid:tenant_id>/workflows/<uuid:pk>/', views.RoutineDetail.as_view(), name='routine-detail'),
    ...
    path('<uuid:tenant_id>/workflows/<uuid:pk>/printable/', views.RoutineDetailPrintable.as_view(), name='routine-detail-printable'),
