...
urlpatterns = [
    ...
    path('<uuid:tenant_id>/responsibilities/<uuid:pk>/add-types/<str:types>/', views.ResponsibilityAddTypes.as_view(), name='responsibility-add-types'),
    path('<uuid:tenant_id>/responsibilities/<uuid:pk>/remove-types/<str:types>/', views.ResponsibilityRemoveTypes.as_view(), name='responsibility-remove-types'),
