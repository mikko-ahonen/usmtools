...
urlpatterns = [
    ...
    path('<uuid:tenant_id>/profiles/<uuid:pk>/tasks/create/', views.TaskCreate.as_view(), name='profile-task-create'),
    path('<uuid:tenant_id>/tasks/create/', views.TaskCreate.as_view(), name='task-create'),
