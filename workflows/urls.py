...
urlpatterns = [
    ...
    path('<uuid:tenant_id>/services/<uuid:pk>/profiles/', views.ServiceProfileList.as_view(), name='service-profile-list'),
    #path('<uuid:tenant_id>/profiles/', views.ProfileList.as_view(), name='profile-list'),
    path('<uuid:tenant_id>/services/<uuid:service_id>/profiles/<uuid:pk>/', views.ServiceProfileDetail.as_view(), name='service-profile-detail'),
    path('<uuid:tenant_id>/profiles/<uuid:pk>/', views.ProfileDetail.as_view(), name='profile-detail'),
    path('<uuid:tenant_id>/services/<uuid:service_id>/profiles/create/', views.ServiceProfileCreate.as_view(), name='service-profile-create'),
    path('<uuid:tenant_id>/services/<uuid:service_id>/profiles/<uuid:pk>/delete/', views.ServiceProfileDelete.as_view(), name='service-profile-delete'),
    path('<uuid:tenant_id>/services/<uuid:service_id>/profiles/<uuid:pk>/update/', views.ServiceProfileUpdate.as_view(), name='service-profile-update'),
    ...
    path('<uuid:tenant_id>/services/<uuid:pk>/customers/', views.ServiceCustomerList.as_view(), name='service-customer-list'),
    ...
    path('<uuid:tenant_id>/routines/<uuid:pk>/diagram/png/', views.RoutineDiagramPNG.as_view(), name='routine-diagram-png'),
    path('<uuid:tenant_id>/routines/<uuid:pk>/diagram/svg/', views.RoutineDiagramSVG.as_view(), name='routine-diagram-svg'),
    path('<uuid:tenant_id>/routines/<uuid:pk>/diagram/bpmn/', views.RoutineDiagramBPMN.as_view(), name='routine-diagram-bpmn'),
    ...
    path('<uuid:tenant_id>/services/<uuid:service_id>/profiles/<uuid:pk>/tasks/create/', views.ServiceTaskCreate.as_view(), name='service-profile-task-create'),
    path('<uuid:tenant_id>/services/<uuid:service_id>/tasks/create/', views.ServiceTaskCreate.as_view(), name='service-task-create'),
    path('<uuid:tenant_id>/services/<uuid:pk>/routines/', views.ServiceRoutineList.as_view(), name='service-routine-list'),
    path('<uuid:tenant_id>/services/<uuid:pk>/tasks/', views.ServiceTaskList.as_view(), name='service-task-list'),
    path('<uuid:tenant_id>/services/<uuid:pk>/responsibilities/', views.ServiceResponsibilityList.as_view(), name='service-responsibility-list'),
    path('<uuid:tenant_id>/services/<uuid:service_id>/tasks/<uuid:pk>/', views.ServiceTaskDetail.as_view(), name='service-task-detail'),
