...
urlpatterns = [
    ...
    path('cross-references/<uuid:cross_reference_id>/', views.CrossReferenceDetail.as_view(), name='cross-reference-detail'),
    ...
    path('sections/<uuid:section_id>/', views.CrossReferenceDetail.as_view(), name='section-detail'),
    path('requirements/<uuid:requirement_id>/', views.CrossReferenceDetail.as_view(), name='requirement-detail'),
    path('statements/<uuid:statement_id>/', views.CrossReferenceDetail.as_view(), name='statement-detail'),
    path('statements/<uuid:statement_id>/constraints/<uuid:constraint_id>/', views.CrossReferenceDetail.as_view(), name='constraint-detail'),
    ...
    path('statements/<uuid:statement_id>/constraints/<uuid:pk>/delete', views.ConstraintDelete.as_view(), name='constraint-delete'),
    path('statements/<uuid:statement_id>/constraints/<uuid:pk>/update', views.ConstraintUpdate.as_view(), name='constraint-update'),
]
