...
class OrgChart(component.Component):
    ...
    def get_context_data(self, **kwargs):
        ...
        return {
            "org_unit": org_unit,
            "orgchart_data": org_unit_as_orgchart_data(org_unit),
            "tenant_id": tenant_id,
        }

    def org_unit_as_orgchart_data(org_unit):
        return {
            'name': org_unit.name,
            'children': [org_unit_as_orgchart_data(x) for x in org_unit.children.all()],
        }
